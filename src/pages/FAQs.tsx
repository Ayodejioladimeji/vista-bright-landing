        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto animate-fade-in-up">
            ...
            <p className="text-xl text-primary-foreground/90">
              We've answered some of the most common questions to help you get started with
              confidence.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="animate-fade-in-up">
              <h2 className="font-heading font-bold text-3xl mb-6 text-primary">Loans</h2>
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: "100ms" }}>
              <h2 className="font-heading font-bold text-3xl mb-6 text-secondary">Investments</h2>
              <Accordion type="single" collapsible className="space-y-4">
                {investmentFAQs.map((faq, index) => (
                  <AccordionItem
                    ...
                    className="border border-border rounded-lg px-6 bg-card shadow-soft"
                  >
                    <AccordionTrigger className="text-left font-heading font-semibold text-lg hover:text-secondary">
                      {faq.question}
                    </AccordionTrigger>
                    <AccordionContent className="text-muted-foreground text-base pt-2">
                      {faq.answer}
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: "200ms" }}>
              <h2 className="font-heading font-bold text-3xl mb-6 text-foreground">General</h2>
              <Accordion type="single" collapsible className="space-y-4">
                {generalFAQs.map((faq, index) => (
                  <AccordionItem
                    ...
                    className="border border-border rounded-lg px-6 bg-card shadow-soft"
                  >
                    <AccordionTrigger className="text-left font-heading font-semibold text-lg hover:text-foreground">
                      {faq.question}
                    </AccordionTrigger>
                    <AccordionContent className="text-muted-foreground text-base pt-2">
                      {faq.answer}
